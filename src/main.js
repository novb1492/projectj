...
Vue.prototype.$serverDomain = 'http://ec2-user@ec2-54-180-89-72.ap-northeast-2.compute.amazonaws.com:8080';
...
Vue.prototype.$footerHeigth=50;//수정시 사이드바 width는 가서 직접 수정해줘야한다
Vue.prototype.$deliverSocketUrl='/auth/ws/deliver';
Vue.prototype.$shortServerDomain=' ec2-user@ec2-54-180-89-72.ap-northeast-2.compute.amazonaws.com:8080';//웹소켓통신시 사용
