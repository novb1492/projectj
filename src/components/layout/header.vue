...
export default {
  ...
  methods : {
    ...
    useHeader(){
        var showOrNot=true;
        if(this.uri=='/makeDeliverRoomPage'||this.uri=='/store/paymentDetailPage'||this.uri=='/resultPage'||this.uri=='/joinPage'||this.uri=='/loginPage'||this.uri=='/myPage'||this.uri=='/findPwdPage'||this.uri=='/findEmailPage'||this.uri=='/changePhonePage'||this.uri=='/showItemPage'||this.uri=='/showSucBuyPage'||this.uri=='/popUpClose'||this.uri=='/beforeJoinPage'||this.uri=='/authPage'||this.uri=='/findAccountPage'){
           showOrNot= false;
        }
        return showOrNot;
    },
